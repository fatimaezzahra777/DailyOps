...
{{ $manager?->name ?? 'Un manager' }} vous invite à rejoindre le projet **{{ $project->name }}** sur {{ config('app.name') }}.
...
Ce lien expire dans 7 jours. Si vous n’attendiez pas cette invitation, vous pouvez ignorer cet e-mail.
