    ...
    <section class="mx-auto max-w-5xl space-y-6">
        <div class="flex flex-wrap items-start justify-between gap-4">
            <div>
                ...
                <p class="mt-2 text-sm text-[var(--muted)]">Create a task and attach it to the right project from the same workspace.</p>
            </div>

            <div class="flex gap-3">
                <a href="{{ route('tasks.index') }}" class="btn-secondary">Back to tasks</a>
                <a href="{{ route('projects.index') }}" class="btn-secondary">Projects board</a>
            </div>
        </div>
