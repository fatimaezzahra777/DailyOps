            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="font-['Syne'] text-base font-bold tracking-wide text-[#0a0a0a]">
                        {{ ($isAdmin ?? false) ? 'Tableau de bord administrateur' : 'Tableau de bord membre' }}
                    </h2>
                    <p class="mt-1 text-[12.5px] text-[#888888]">
                        {{ ($isAdmin ?? false) ? 'Statistiques, utilisateurs et activité DailyOps.' : 'Vue d’ensemble de vos projets et de votre activité.' }}
                    </p>
                </div>
            </div>
        ...
        <div class="mx-auto max-w-7xl">
            @if (! ($isAdmin ?? false))
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-4">
                    <div class="relative overflow-hidden rounded-[10px] border border-[#c50064]/20 bg-white p-4 shadow-sm">
                        ...
                        <p class="mt-2 flex items-center gap-1 text-[11px] text-[#c50064]"><i class="ti ti-layout-kanban text-xs"></i> Projets de l’espace</p>
                    </div>
                                ...
                                <div class="flex flex-col gap-3 px-5 py-4 sm:flex-row sm:items-center sm:justify-between">
                                    <div>
                                        ...
                                        <div class="mt-1 text-[12.5px] text-[#888888]">
                                            {{ $project->end_date ? 'Échéance : '.$project->end_date->format('d/m/Y') : 'Aucune échéance' }}
                                        </div>
                                    </div>
            ...
            @else
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-5">
                    <div class="relative overflow-hidden rounded-[10px] border border-[#c50064]/20 bg-white p-4 shadow-sm">
                        <div class="absolute right-0 top-0 h-20 w-20 bg-[radial-gradient(circle_at_top_right,rgba(197,0,100,0.16),transparent_70%)]"></div>
                        <p class="font-['Syne'] text-[10.5px] uppercase tracking-[0.08em] text-[#888888]">Total des utilisateurs</p>
                        <p class="mt-2 font-['Syne'] text-[26px] font-bold leading-none text-[#0a0a0a]">{{ $stats['total_users'] }}</p>
                        <p class="mt-2 flex items-center gap-1 text-[11px] text-[#c50064]"><i class="ti ti-users text-xs"></i> Tous les comptes</p>
                    </div>

                    <div class="rounded-[10px] border border-black/10 bg-white p-4 shadow-sm">
                        <p class="font-['Syne'] text-[10.5px] uppercase tracking-[0.08em] text-[#888888]">Membres</p>
                        <p class="mt-2 font-['Syne'] text-[26px] font-bold leading-none text-[#0a0a0a]">{{ $stats['members'] }}</p>
                        <p class="mt-2 text-[11px] text-[#00a86b]">Rôle standard</p>
                    </div>

                    <div class="rounded-[10px] border border-black/10 bg-white p-4 shadow-sm">
                        <p class="font-['Syne'] text-[10.5px] uppercase tracking-[0.08em] text-[#888888]">Comptes vérifiés</p>
                        <p class="mt-2 font-['Syne'] text-[26px] font-bold leading-none text-[#0a0a0a]">{{ $stats['verified'] }}</p>
                        <p class="mt-2 text-[11px] text-[#999999]">Adresse e-mail vérifiée</p>
                    </div>
                    ...
                    <div class="rounded-[10px] border border-black/10 bg-white p-4 shadow-sm">
                        ...
                        <p class="mt-2 text-[11px] text-[#999999]">Nouveaux comptes</p>
                    </div>
                </div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-[#f7f7f7]">
                                    <tr>
                                        ...
                                        <th class="px-5 py-3 text-left font-['Syne'] text-[10px] font-semibold uppercase tracking-[0.08em] text-[#999999]">Rôle</th>
                                        <th class="px-5 py-3 text-left font-['Syne'] text-[10px] font-semibold uppercase tracking-[0.08em] text-[#999999]">Créé le</th>
